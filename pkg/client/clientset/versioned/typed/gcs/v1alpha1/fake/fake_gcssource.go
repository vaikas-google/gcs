...
var gcssourcesResource = schema.GroupVersionResource{Group: "sources.aikas.org", Version: "v1alpha1", Resource: "gcssources"}

var gcssourcesKind = schema.GroupVersionKind{Group: "sources.aikas.org", Version: "v1alpha1", Kind: "GCSSource"}
